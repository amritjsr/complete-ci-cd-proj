"""
Django settings for emp_mgmt_backend project.
...
ROOT_URLCONF = 'emp_mgmt_backend.urls'
...
WSGI_APPLICATION = 'emp_mgmt_backend.wsgi.application'
...
# MySQL Database Configuration items extracted from environment variables for security
